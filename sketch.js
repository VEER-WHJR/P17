...
function setup() {
  ...
  mainCyclist.setCollider("circle", -100, 0, 650);
...
function draw() {
  ...
  if (gameState === PLAY) {
    ...
    var ch = Math.round(random(1, 2));
    //code to play cycle bell sound
    if (keyDown("space")) {
      cycleBell.play();
      if (ch === 1) {
        redCG.setVelocityYEach(-4);
        yellowCG.setVelocityYEach(-4);
        pinkCG.setVelocityYEach(-4);
      } else {
        redCG.setVelocityYEach(4);
        yellowCG.setVelocityYEach(4);
        pinkCG.setVelocityYEach(4);
...
function pinkCyclists() {
  ...
  pinkCG.add(player1);
  player1.setCollider("circle", -100, 0, 650);
}
...
function yellowCyclists() {
  ...
  player2.setCollider("circle", -100, 0, 650);
}
...
function redCyclists() {
  ...
  redCG.add(player3);
  player3.setCollider("circle", -100, 0, 650);
}
